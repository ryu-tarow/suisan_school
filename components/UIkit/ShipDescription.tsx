...
export const ShipDescription = ({
  ...
  return (
    <div className="sm:flex mb-1 relative">
      ...
      />
      <div>
        <div className="flex sm:px-2 py-4 mb-2">
          ...
          <div className="pl-5 pr-2">
            ...
            <div className="flex">
              <p className="text-sm">{schoolName01}</p>
              <Link href={link01}>
            ...
            <div className={`flex ${class01}`}>
              <p className="text-sm">{schoolName02}</p>
              <Link href={link02}>
                <div className="w-4 mt-0.5 mx-1 text-gray-400 hover:opacity-60 duration-300">
                  <svg
                    xmlns="http://www.w3.org/2000/svg"
            ...
            <div className={`flex ${class02}`}>
              <p className="text-sm">{schoolName03}</p>
              <Link href={link03}>
                <div className="w-4 mt-0.5 mx-1 text-gray-400 hover:opacity-60 duration-300">
                  <svg
                    xmlns="http://www.w3.org/2000/svg"
